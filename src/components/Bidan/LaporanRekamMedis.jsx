...
import {
  ...
  FaStethoscope, FaBaby, FaBookMedical, FaSyringe, FaBell, FaUserCircle, FaPrint, FaClipboardList
} from "react-icons/fa";
...
const RekamMedis = () => {
  ...
  const handleChangePasien = (e) => {
    ...
    setSelectedPasien(dataPasien || null);
  };
  ...
  const handlePrint = () => {
    ...
    newWindow.document.write(`
      <html><head><title>Cetak Rekam Medis</title></head>
  ...
  return (
    <div className="d-flex">
      {/* Sidebar */}
      <Nav className="flex-column p-3" style={{
        ...
        <Nav.Link as={Link} to="/bidan/laporan-rekam-medis" className="fw-semibold mb-3 pb-3 border-bottom rounded px-2"
        ...
        <Navbar bg="white" className="mb-4 px-3 shadow-sm d-flex justify-content-between align-items-center rounded-3"
          ...
          <div className="d-flex align-items-center">
            <NavDropdown align="end" className="ms-4" title={<FaBell size={24} />} id="notifikasi-dropdown">
              <NavDropdown.Item>Notifikasi A</NavDropdown.Item>
            </NavDropdown>
